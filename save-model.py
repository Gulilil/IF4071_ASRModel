...
model.save_pretrained("./saved_models/wav2vec2")
processor.save_pretrained("./saved_models/wav2vec2")
...
bart_model.save_pretrained("./saved_models/bart")
bart_tokenizer.save_pretrained("./saved_models/bart")
